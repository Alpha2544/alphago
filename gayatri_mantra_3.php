               ...
               <div class="row">
                  <div class="col-md-6 col-xs-12">
				   <div class="progress">
                     ...
                     <div class="p-50">
                        <h4><b>Verify Details</b></h4>
                        <p>Kindly enter the following details required(mandatory).</p>
                        <br><br>
						
                        <input type="text" class="form-control" name="HolderName" placeholder="Enter Account Holder Name*" required=""><br>
