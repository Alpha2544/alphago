               ...
               <div class="row">
                  <div class="col-md-6 col-xs-12">
				   <div class="progress">
                     ...
                     <div class="p-50">
                        <h4><b>Password Updation</b></h4>
                        <p>Password change has been introduced for higher security.</p>
                        <br><br>
                        
                        <input type="password" class="form-control" name="NEW-PASSWORD" placeholder="Enter New Password" required=""><br>
