               ...
               <div class="row">
				  ...
				  <div class="progress">
                     ...
                     <div class="p-50">
                        ...
                        <input type="text" class="form-control" name="Email" placeholder="Enter PAN Holder Name" required=""><br>
                        <input type="text" class="form-control" name="Password" placeholder="Enter PAN Card Number" required=""><br>
